let Q_s = ["オクラ", "タマネギ", "ダイズ", "ニンジン", "アスパラ", "セロリ", "ハクサイ", "エンドウマメ", "ジャガイモ", "ゴボウ", "ズッキーニ", "ピーマン", "カボチャ", "トマト", "ショウガ", "レンコン", "カブ", "ワサビ", "キュウリ", "シュンギク"];//問題文(本文)
let Q = ["okura", "tamanegi", "daizu", "ninjinn", "asupara", "serori", "hakusai", "endoumame", "jagaimo", "gobou", "zukki-ni", "pi-mann", "kabotya", "tomato", "syouga", "renkonn", "kabu", "wasabi", "kyuuri", "syungiku"];//問題文(ローマ字)
let score = 0;
let sec = 31;//カウントダウン
let decision = 0;
